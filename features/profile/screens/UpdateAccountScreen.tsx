...
import { View, StyleSheet, ScrollView, KeyboardAvoidingView, Platform, TouchableOpacity, Alert, Image, StatusBar, ActivityIndicator } from "react-native";
                ...
                <View style={[styles.mainContent, { backgroundColor: theme.background }]}>
                    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.keyboardView}>
                        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                            <Text className="text-2xl font-bold mb-6" style={{ color: theme.foreground }}>Account Info</Text>

                            <TouchableOpacity 
                                style={[styles.photoCard, { borderColor: theme.border, backgroundColor: theme.card }]} 
                                activeOpacity={0.7}
                            ...
                            >
                                ...
                                <View style={styles.photoInfo}>
                                    <Text className="font-bold text-sm" style={{ color: theme.foreground }}>Your Photo</Text>
                            ...
                            <View style={styles.formContainer}>
                                <View style={styles.inputGroup}>
                                    ...
                                    <Input
                                        ...
                                        style={[styles.inputCustom, { borderColor: errors.fullName ? theme.destructive : theme.border }]}
                                    />
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    <Input
                                        ...
                                        autoCapitalize="none"
                                        style={[styles.inputCustom, { borderColor: errors.email ? theme.destructive : theme.border }]}
                                    />
                            ...
                            <View style={styles.buttonWrapper}>
                                <Button
                                    ...
                                    style={[styles.saveButton, { backgroundColor: theme.foreground }, (isLoading || isUploading) && { opacity: 0.7 }]}
                                >
...
const styles = StyleSheet.create({
    ...
    photoCard: { flexDirection: "row", alignItems: "center", padding: 16, borderRadius: 16, borderWidth: 1, marginBottom: 30 },
    avatarWrapper: { position: "relative" },
    avatarPlaceholder: { width: 60, height: 60, borderRadius: 30, justifyContent: "center", alignItems: "center", overflow: 'hidden' },
    plusIcon: { position: "absolute", bottom: 0, right: 0, width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: "white", justifyContent: "center", alignItems: "center" },
    ...
    countryBadge: { flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderRadius: 15, paddingHorizontal: 12, height: 52 },
