...
export default function KycVerificationScreen({ navigation }: Props) {
    ...
    const [images, setImages] = useState<Record<ImageKey, string | undefined>>({ front: undefined, back: undefined, selfie: undefined });
                    ...
                    <React.Fragment key={step.key}>
                        <View style={styles.stepDot}>
                            <View
                                ...
                                {isCompleted || isReview ? (
                                    ...
                                    <Text style={[styles.dotText, isCurrent && styles.dotTextActive]}>
                                        {index + 1}
                                    </Text>
                                )}
                            </View>
                        ...
                        {index < STEPS.length - 1 && (
                            <View
                                style={[
                                    styles.stepLine,
                                    (isCompleted || isReview) && { backgroundColor: theme.primary },
                                ]}
                            />
                        )}
                    </React.Fragment>
    ...
    const renderCamera = () => (
        <View style={styles.cameraContainer}>
            <CameraView
                ref={cameraRef}
                style={styles.camera}
                facing={currentConfig.cameraFacing}
            >
        ...
        <ScrollView
            ...
            <View style={styles.actionButtons}>
                ...
                <TouchableOpacity
                    ...
                    <Text style={[styles.actionBtnHint, { color: theme.mutedForeground }]}>
                        From your gallery
                    </Text>
                </TouchableOpacity>
            </View>
            ...
            <ScrollView
                        ...
                        {kycResult.faceMatchScore != null && (
                            <View style={styles.resultRow}>
                                ...
                                <Text style={[styles.resultValue, { color: '#22C55E' }]}>
                                    {kycResult.faceMatchScore.toFixed(1)}%
                                </Text>
                            </View>
                        )}
                    </View>
                ...
                <TouchableOpacity
                    ...
                    <Text style={styles.submitBtnText}>
                        {isSuccess ? 'Back to Profile' : 'Try Again Later'}
                    </Text>
                </TouchableOpacity>
            </ScrollView>
        );
