...
export default function WithdrawScreen() {
    ...
    const renderFaceStep = () => (
        <View style={styles.faceStepContainer}>
            ...
            <Text style={[styles.faceTitle, { color: theme.foreground }]}>
                Face Verification
            </Text>
            ...
            <TouchableOpacity
                ...
                <Text style={styles.cameraActionBtnText}>
                    {livePhotoUri ? 'Retake Photo' : 'Open Camera'}
                </Text>
                ...
                <View style={[styles.summaryCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                    ...
                    {livePhotoUri && (
                        <View style={styles.confirmFaceRow}>
                            <Image
                                source={{ uri: livePhotoUri }}
                                style={styles.confirmFaceImage}
                                resizeMode="cover"
                            />
                            <View style={{ flex: 1 }}>
                                <Text style={[styles.confirmLabel, { color: theme.mutedForeground }]}>
                                    Face Verification
                                </Text>
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <Text style={[styles.confirmValue, { color: theme.foreground }]}>
                    ...
                    {isLoading ? (
                        ...
                        <View style={styles.buttonContent}>
                            ...
                            <Text style={styles.buttonText}>
                                Confirm Withdraw {formatCurrency(withdrawAmount)}
                            </Text>
                        </View>
                    )}
                </TouchableOpacity>
                        ...
                        {(['amount', 'face', 'confirm'] as const).map((s, i) => {
                            ...
                            return (
                                <View key={s} style={styles.stepDotWrap}>
                                    ...
                                    <Text style={[styles.stepDotLabel, isCurrent && { fontWeight: '700' }]}>
                                        {labels[i]}
                                    </Text>
                                    {i < 2 && (
                                        <View
