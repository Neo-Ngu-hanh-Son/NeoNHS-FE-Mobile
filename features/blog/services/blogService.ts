...
import type { BlogResponse, BlogPageResponse, BlogListParams, BlogCategoryParams, BlogCategoryResponse } from '../types';
...
export const blogService = {
  ...
  getBlogPreviews: async (params: BlogListParams = {}): Promise<BlogPageResponse> => {
    const queryParams: Record<string, string | number | boolean> = {};
    if (params.page !== undefined) queryParams.page = params.page;
    if (params.size !== undefined) queryParams.size = params.size;
    if (params.search) queryParams.search = params.search;
    ...
    const response = await apiClient.get<BlogPageResponse>(endpoints.blog.getBlogsPreviews(), {
      requiresAuth: false,
      params: queryParams,
    });
  ...
  getBlogCategories: async (params: BlogCategoryParams = {}): Promise<PageResponse<BlogCategoryResponse>> => {
    const queryParams: Record<string, string | number | boolean> = {};
    if (params.page !== undefined) queryParams.page = params.page;
    if (params.size !== undefined) queryParams.size = params.size;
    if (params.sortBy) queryParams.sortBy = params.sortBy;
    ...
    const response = await apiClient.get<PageResponse<BlogCategoryResponse>>(endpoints.blog.getBlogCategories(), {
      requiresAuth: false,
      params: queryParams,
    });
