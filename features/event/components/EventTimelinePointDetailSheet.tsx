...
const EventTimelinePointDetailSheet = forwardRef<EventTimelinePointDetailSheetRef, EventTimelinePointDetailSheetProps>(
  ({ point, onAfterClose, onStartNavigate }, ref) => {
        ...
        <BottomSheetScrollView
            ...
            {(point.pointName ?? point.address) ? (
              <View style={[styles.locationCard, { backgroundColor: theme.background, borderColor: theme.border }]}>
                <View style={[styles.locationIconWrap, { backgroundColor: hexAlpha('#ef4444', '18') }]}>
                  {point.eventPointTag?.iconUrl ? (
                    <Image
                      source={{ uri: point.eventPointTag.iconUrl }}
          ...
          <View style={[styles.ctaWrap, { borderTopColor: theme.border }]}>
            <TouchableOpacity
              ...
              accessibilityLabel="Get directions to this point">
...
EventTimelinePointDetailSheet.displayName = 'EventTimelinePointDetailSheet';
export default EventTimelinePointDetailSheet;
