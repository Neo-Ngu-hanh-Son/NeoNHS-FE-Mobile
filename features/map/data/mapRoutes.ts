...
export const ROUTE_COORDINATES = {
  ...
  mainPath: [
    { latitude: 16.002819, longitude: 108.26247 }, // Cong vao 1, cau thang 1
  ...
  straightBranchStraight: [
    ...
    { latitude: 16.003896, longitude: 108.26265 }, // Con duong nho
    { latitude: 16.004066, longitude: 108.26287 }, // Nga tu - Diem ban nuoc
  ],
  ...
  straightBranchRight: [
    ...
    { latitude: 16.00369, longitude: 108.262963 }, // Check in point
  ],
};

// Define all routes with their IDs and colors
// Each route is a set of coordinates from ROUTE_COORDINATES
export const ALL_ROUTES = [
  ...
  { id: 'straight', coordinates: ROUTE_COORDINATES.straightBranch, color: '#22c55e' },
  {
    ...
    coordinates: ROUTE_COORDINATES.straightBranchStraight,
    color: '#22c55e',
  },
