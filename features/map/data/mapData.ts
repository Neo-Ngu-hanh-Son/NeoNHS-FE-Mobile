...
export const mapPoints: MapPoint[] = [
  ...
  // KHU A POIs
  // ======================
  { id: 'offline-1', name: 'Chua Tam Ton', latitude: 16.003891, longitude: 108.262156, orderIndex: 1, estTimeSpent: 8, type: 'PAGODA', description: 'Main pagoda in Khu A with spiritual significance.' },
  { id: 'offline-2', name: 'Chua Tu Tam', latitude: 16.004066, longitude: 108.26144, orderIndex: 2, estTimeSpent: 6, type: 'PAGODA', description: 'Secondary pagoda with tranquil surroundings.' },
  { id: 'offline-3', name: 'Thap Cao (Check-in)', latitude: 16.003556, longitude: 108.262135, orderIndex: 3, estTimeSpent: 4, type: 'CHECKIN', description: 'Scenic check-in spot overlooking the main paths.' },
  { id: 'offline-4', name: 'Chua Tam Thai', latitude: 16.003821, longitude: 108.262714, orderIndex: 4, estTimeSpent: 6, type: 'PAGODA', description: 'Historic temple situated along the upper path.' },
  { id: 'offline-5', name: 'Diem ban nuoc', latitude: 16.004071, longitude: 108.262867, orderIndex: 5, estTimeSpent: 3, type: 'SHOP', description: 'Refreshment stand for drinks and quick rest.' },
  { id: 'offline-6', name: 'Huyen Khong Cave', latitude: 16.004184, longitude: 108.262342, orderIndex: 6, estTimeSpent: 10, type: 'CAVE', description: 'Entrance to a cave exploration path.' },
  { id: 'offline-7', name: 'Linh Nham Cave', latitude: 16.0042103, longitude: 108.2630874, orderIndex: 7, estTimeSpent: 12, type: 'CAVE', description: 'Larger cave site for visitors to explore.' },
  { id: 'offline-8', name: 'View Point (Check-in)', latitude: 16.004277, longitude: 108.263532, orderIndex: 8, estTimeSpent: 5, type: 'VIEWPOINT', description: 'Panoramic viewpoint ideal for photos.' },
  { id: 'offline-9', name: 'Nha ve sinh', latitude: 16.0046067, longitude: 108.2627529, orderIndex: 9, estTimeSpent: 2, type: 'GENERAL', description: 'Public restroom facilities.' },
  { id: 'offline-10', name: 'Van Thong Cave', latitude: 16.003828, longitude: 108.263528, orderIndex: 10, estTimeSpent: 8, type: 'CAVE', description: 'Secondary cave entrance along the path.' },

  // ======================
  // KHU B POIs
  // ======================
  { id: 'offline-11', name: 'Pagoda entrance', latitude: 16.004003, longitude: 108.264472, orderIndex: 11, estTimeSpent: 5, type: 'PAGODA', description: 'Entrance pagoda marking the start of Khu B.' },
  { id: 'offline-12', name: 'Buddha statue', latitude: 16.004313, longitude: 108.264573, orderIndex: 12, estTimeSpent: 4, type: 'STATUE', description: 'Statue landmark popular for photographic check-ins.' },
  { id: 'offline-13', name: 'Dong Tang Chon', latitude: 16.004282, longitude: 108.26413, orderIndex: 13, estTimeSpent: 10, type: 'CAVE', description: 'Cave entrance located along the B zone paths.' },
  { id: 'offline-14', name: 'Artwork', latitude: 16.003992, longitude: 108.264291, orderIndex: 14, estTimeSpent: 3, type: 'CHECKIN', description: 'Artistic piece worth stopping for photos.' },
  { id: 'offline-15', name: 'Thap Xa Loi', latitude: 16.00354, longitude: 108.264308, orderIndex: 15, estTimeSpent: 6, type: 'PAGODA', description: 'Memorial tower landmark.' },
  { id: 'offline-16', name: 'Vong Hai Dai', latitude: 16.003689, longitude: 108.264221, orderIndex: 16, estTimeSpent: 5, type: 'GENERAL', description: 'Scenic rest area along the B zone route.' },
  { id: 'offline-17', name: 'Fountains?', latitude: 16.004079, longitude: 108.264651, orderIndex: 17, estTimeSpent: 2, type: 'CHECKIN', description: 'Decorative fountains ideal for quick photo stop.' },
  { id: 'offline-18', name: 'Viewing point', latitude: 16.004204, longitude: 108.264765, orderIndex: 18, estTimeSpent: 4, type: 'VIEWPOINT', description: 'Additional scenic viewpoint in B zone.' },
];
